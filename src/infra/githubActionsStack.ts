...
function GithubActionsStack({ app, stack }: StackContext) {
  if (app.stage === "prod") {
    ...
    const organization = "louismollick"; // Use your GitHub organization
    const repository = "lyricsu"; // Use your GitHub repository
...
export default GithubActionsStack;
